 ...
 */
final class Version20231011121116 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adress (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, adress VARCHAR(255) NOT NULL, complementary_adress VARCHAR(255) DEFAULT NULL, city VARCHAR(255) NOT NULL, zip_code INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5CECC7BEF92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, product_name VARCHAR(255) NOT NULL, full_price INT NOT NULL, popularity TINYINT(1) NOT NULL, quantity INT NOT NULL, reduc_price INT DEFAULT NULL, picture VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
